...
<p align="center"><img src="docs/screenshots/compose-5.png" width="700" alt="Compose window"></p>
...
<p align="center"><img src="docs/screenshots/settings-5.png" width="800" alt="Settings"></p>
...
| Version | Highlights |
|---|---|
| 0.9.8 | The inbox shows everything Gmail puts in Primary: mail Gmail files under "Updates" or "Forums" (order notifications, receipts, invoices — most of a business inbox) was hidden with no tab to find it under. Also the macOS build 0.9.7 was missing |
| 0.9.7 | One bar across the top with search in the middle, one compact message header with all the reply actions in it (no more duplicate Reply buttons), "always load images from this sender", new mail that keeps arriving during a first sync even when Gmail is rate-limiting the download, Electron 44.4 and current dependencies, and a release check that only publishes a complete build |
