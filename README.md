...
| Version | Highlights |
|---|---|
| 0.9.7 | One compact message header with all the reply actions in it (no more duplicate Reply buttons), Electron 44.4 and current dependencies, and a release check that only publishes a complete build |
